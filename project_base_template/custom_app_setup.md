...
**Step 2:** Copy the template files **verbatim** from
`.cursor/frappe-skills/project_base_template/commands/` into that folder:

```bash
cp .cursor/frappe-skills/project_base_template/commands/__init__.py \
   .cursor/frappe-skills/project_base_template/commands/export_fixtures.py \
   .cursor/frappe-skills/project_base_template/commands/README.md \
